...
function showColor(color) {
	...
	exec("echo " + config.pins.red + "=" + (color.red / 255) + " > dev/pi-blaster");
	exec("echo " + config.pins.green + "=" + (color.green / 255) + " > dev/pi-blaster");
	exec("echo " + config.pins.blue + "=" + (color.blue / 255) + " > dev/pi-blaster");
}
